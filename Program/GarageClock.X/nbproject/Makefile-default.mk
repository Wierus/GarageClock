...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/GarageClock.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=DS1307.c DS18B20.c I2C.c Math.c OneWire.c TaskManager.c main.c SevenSegmentDisplay.c SevenSegmentDisplayDS18B20.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/DS1307.p1 ${OBJECTDIR}/DS18B20.p1 ${OBJECTDIR}/I2C.p1 ${OBJECTDIR}/Math.p1 ${OBJECTDIR}/OneWire.p1 ${OBJECTDIR}/TaskManager.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/SevenSegmentDisplay.p1 ${OBJECTDIR}/SevenSegmentDisplayDS18B20.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/DS1307.p1.d ${OBJECTDIR}/DS18B20.p1.d ${OBJECTDIR}/I2C.p1.d ${OBJECTDIR}/Math.p1.d ${OBJECTDIR}/OneWire.p1.d ${OBJECTDIR}/TaskManager.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/SevenSegmentDisplay.p1.d ${OBJECTDIR}/SevenSegmentDisplayDS18B20.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/DS1307.p1 ${OBJECTDIR}/DS18B20.p1 ${OBJECTDIR}/I2C.p1 ${OBJECTDIR}/Math.p1 ${OBJECTDIR}/OneWire.p1 ${OBJECTDIR}/TaskManager.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/SevenSegmentDisplay.p1 ${OBJECTDIR}/SevenSegmentDisplayDS18B20.p1

# Source Files
SOURCEFILES=DS1307.c DS18B20.c I2C.c Math.c OneWire.c TaskManager.c main.c SevenSegmentDisplay.c SevenSegmentDisplayDS18B20.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/GarageClock.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/GarageClock.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/GarageClock.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=none  --double=24 --float=24 --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=-3 --asmlist --summary=default,-psect,-class,+mem,-hex,+file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        -odist/${CND_CONF}/${IMAGE_TYPE}/GarageClock.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/GarageClock.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/GarageClock.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/GarageClock.X.${IMAGE_TYPE}.map  --double=24 --float=24 --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=-3 --asmlist --summary=default,-psect,-class,+mem,-hex,+file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -odist/${CND_CONF}/${IMAGE_TYPE}/GarageClock.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
